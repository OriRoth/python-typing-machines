"""
The application acknowledges the machines specified in this file
inside `all_machines`.
"""
...
all_machines: Dict[str, TuringMachine] = {
	"anbn": TuringMachine("q0", "q4", [
	...
	"palindromes": TuringMachine("q0", "q8", [
		Transition("q0", "a", "q1", "c", Direction.RIGHT),
